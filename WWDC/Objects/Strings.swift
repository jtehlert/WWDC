...
struct Strings {
    ...
    static let dataKeyBackgroundColor = "backgroundcolor"
    static let dataKeyBackgroundColorRed = "red"
    static let dataKeyBackgroundColorBlue = "blue"
    static let dataKeyBackgroundColorGreen = "green"
